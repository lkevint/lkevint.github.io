    ...
    <main className="main">
      <section className="intro-section">
        ...
        <div className="social-links">
          <a className="button" href="https://github.com/lkevint" target="_blank" rel="noopener noreferrer">
            <Github className="icon" /> GitHub
          </a>
          <a className="button" href="https://github.com/magicianmathematician" target="_blank" rel="noopener noreferrer">
            <Github className="icon" /> GitHub
          </a>
